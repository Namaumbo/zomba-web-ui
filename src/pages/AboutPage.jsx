            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground md:text-lg">
                  Grace Community Church exists to share the transformative love
                  of Christ with our community and beyond. We are committed to
                  creating a welcoming environment where people from all walks
                  of life can experience God&apos;s grace, grow in their faith,
