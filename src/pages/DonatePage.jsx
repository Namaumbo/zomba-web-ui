              ...
              <Card className="border-purple-200 shadow-xl">
                <CardHeader className="bg-gradient-to-r from-purple-50 to-blue-50 border-b border-purple-100">
                  ...
                  <p className="text-gray-600">
                    Multiple ways to support our ministry
                  </p>
                </CardHeader>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
                      ...
                      <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                        <p className="text-sm text-blue-800">
                          ...
                          "Donation" in the reference field
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-gray-700">
                            Offering baskets are passed during our worship
                            services
                          </p>
                          <p className="text-sm text-gray-600 mt-1">
                            <strong>Service Times:</strong> 8:00 AM & 10:30 AM
                            every Sunday
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            <strong>Hours:</strong> Monday - Friday, 9:00 AM -
                            4:00 PM
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      ...
                      <div className="mt-4 p-3 bg-yellow-100 rounded-lg">
                        <p className="text-sm text-yellow-800">
                          <strong>Tip:</strong> When making your donation,
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-6 border border-indigo-200">
                      ...
                      <p className="text-gray-700 mb-4">
                        Our finance team is here to help with any questions
                        about giving or to provide donation receipts.
                      </p>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm font-medium text-gray-700">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-sm">
                      <Check className="w-4 h-4 text-green-600" />
                      <span className="text-gray-700">
                        150 students received educational materials
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Check className="w-4 h-4 text-green-600" />
                      <span className="text-gray-700">
                        50 families supported through outreach
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Check className="w-4 h-4 text-green-600" />
                      <span className="text-gray-700">
                        Church roof repairs completed
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Check className="w-4 h-4 text-green-600" />
                      <span className="text-gray-700">
                        Youth camp for 75 young people
                      </span>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="border-blue-200">
                ...
                <CardContent>
                  <p className="text-gray-600 text-sm mb-4">
                    Need help with your donation or want to learn more about our
                    programs?
                  </p>
                  <div className="space-y-2 text-sm">
                    <p className="text-gray-700">
                      <span className="font-medium">Email:</span>{" "}
                      giving@zombabaptist.org
                    </p>
                    <p className="text-gray-700">
                      <span className="font-medium">Phone:</span> (+265) 993 740
                      261
                    </p>
                  </div>
                </CardContent>
